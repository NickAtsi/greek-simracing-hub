      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        {loading ? (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-1">Ο admin μπορεί να προσθέσει επεισόδια από το Admin Panel.</p>
          </motion.div>
        ) : (
                ...
                >
                  ...
                  <div className="flex items-center gap-5 p-5">
                    ...
                    <div className="flex-shrink-0 w-10 text-center">
                      ...
                      <p className="font-display text-base font-black text-foreground/60">#{ep.episode_number || i + 1}</p>
                    </div>
