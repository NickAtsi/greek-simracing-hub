          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="rounded-xl border border-border bg-card p-8">
              <Section title="1. Αποδοχή Όρων">
                <p>
                  Χρησιμοποιώντας τον ιστότοπο Greek SimRacers (greeksimracers.gr), αποδέχεστε αυτούς τους Όρους Χρήσης.
                  Αν δεν συμφωνείτε, παρακαλούμε να μην χρησιμοποιείτε τις υπηρεσίες μας.
                </p>
              </Section>
              ...
              <Section title="3. Λογαριασμοί Χρηστών">
                <p>
                  Για να αποκτήσετε πλήρη πρόσβαση στις υπηρεσίες μας, πρέπει να δημιουργήσετε λογαριασμό. Είστε
                  υπεύθυνοι για:
                </p>
                <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <p>
                  Διατηρούμε το δικαίωμα να αναστείλουμε ή να τερματίσουμε λογαριασμούς που παραβαίνουν τους όρους
                  χρήσης.
                </p>
              </Section>
              ...
              <Section title="5. Πνευματική Ιδιοκτησία">
                <p>
                  Το περιεχόμενο που δημιουργείτε (άρθρα, σχόλια, posts) παραμένει δικό σας, αλλά μας παρέχετε άδεια να
                  το εμφανίζουμε στην πλατφόρμα. Το brand Greek SimRacers, το λογότυπο και το αποκλειστικό περιεχόμενο
                  μας προστατεύονται από πνευματικά δικαιώματα.
                </p>
              </Section>

              <Section title="6. Περιορισμός Ευθύνης">
                <p>
                  Το Greek SimRacers δεν φέρει ευθύνη για περιεχόμενο που δημιουργείται από χρήστες. Δεν εγγυόμαστε την
                  αδιάλειπτη λειτουργία της πλατφόρμας. Παρέχουμε τις υπηρεσίες "ως έχουν" χωρίς εγγυήσεις
                  αποτελεσμάτων.
                </p>
              </Section>
              ...
              <Section title="7. Τροποποίηση Όρων">
                <p>
                  Διατηρούμε το δικαίωμα να τροποποιούμε τους παρόντες όρους ανά πάσα στιγμή. Θα σας ειδοποιούμε για
                  σημαντικές αλλαγές. Η συνέχιση χρήσης της πλατφόρμας μετά από αλλαγές συνιστά αποδοχή των νέων όρων.
                </p>
              </Section>

              <Section title="8. Εφαρμοστέο Δίκαιο">
                <p>
                  Οι παρόντες Όροι Χρήσης διέπονται από το ελληνικό δίκαιο και την ευρωπαϊκή νομοθεσία. Για οποιαδήποτε
                  διαφορά, αρμόδια είναι τα δικαστήρια της Αθήνας.
                </p>
              </Section>

              <Section title="9. Επικοινωνία">
                <p>
                  Για ερωτήσεις σχετικά με τους Όρους Χρήσης, επικοινωνήστε μαζί μας στη διεύθυνση:{" "}
                  <strong className="text-foreground">info@greeksimracers.gr</strong>
                </p>
              </Section>
            </div>
          </motion.div>
